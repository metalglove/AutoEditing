...
public class EntryPoint
{
    ...
    public void FromVegas(Vegas vegas)
    {
        try
        {
            ...
            string outPath = @"C:\VEGAS\project-inspection-v2.json";
            File.WriteAllText(outPath, projectJson, new UTF8Encoding(false));

            string diagPath = @"C:\VEGAS\project-inspection-v2-diagnostics-raw.txt";
        ...
        catch (Exception ex)
        {
            ...
            {
                File.WriteAllText(
                    @"C:\VEGAS\project-inspection-v2-FATAL.txt",
                    ex.ToString());
            }
            catch { }
        }
    ...
    static string ExportProject(Vegas vegas)
    {
        ...
        props.Add(Prop("schemaVersion", JS("2.0")));
        props.Add(Prop("inspectorVersion", JS("2.0")));
